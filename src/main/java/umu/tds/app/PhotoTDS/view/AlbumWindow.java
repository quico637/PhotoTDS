...
public class AlbumWindow {
	...
	private static AlbumWindow unicaInstancia = null;
	private String path;
	...
	private void initialize() {
		...
		JLabel lblNewLabel_2 = new JLabel("New Album");
		...
		btnNewButton_1.addActionListener(e -> {
			this.hideWindow();
			if(Controller.getInstancia().createAlbum(this.user, textField_1.getText(), textField.getText(), path))
